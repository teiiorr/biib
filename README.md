...
Карточки цветные, но не шумные: у каждой свой самоцвет в `--gem`, и он появляется ровно трижды —
волосок 2px по верхней кромке, мягкое пятно под номером и ромбики в списке. Текст внутри карточки
остаётся ivory и золотым, поэтому контраст не зависит от выбранного самоцвета.
