export const privacy = {
  ...
  kid: {
    ...
    items: [
      "Biz sen haqingda hech narsa yigʻmaymiz: saytda roʻyxatdan oʻtish, izoh va layk yoʻq.",
      "Rasm yoki surat saytga faqat ota-onang rozi boʻlsa va sen xohlasang chiqadi.",
      "Agar rasmingni olib tashlashni xohlasang, ota-onang bizga yozadi, biz olib tashlaymiz.",
    ],
  },
  sections: [
    {
