...
export const privacy: typeof source = {
  ...
  lead: "What the site collects, why, and for how long it keeps it.",
  updated: "Updated: {date}",
  toc: "Contents",
  legalPending: "The text has not had legal review and awaits confirmation by the association.",
  kid: {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Consent can be withdrawn at any time: write to the address below and the work is removed within two working days.",
      ],
    },
    {
      id: "rights",
      heading: "Your rights",
      paragraphs: [
        "You may ask for, correct or delete the details we hold about you. Send the request to the address on the contacts page.",
      ],
    },
    {
      id: "contact",
      heading: "Contact",
      paragraphs: ["For privacy questions, write to the email address on the contacts page."],
    },
  ],
};
