...
export function fontPreloads(locale: Locale): readonly string[] {
  ...
  if (meta.orthography === "2026") {
    return ["/fonts/manrope-latin.woff2", "/fonts/manrope-latin-ext.woff2"];
  }
  return ["/fonts/manrope-latin.woff2"];
}
...
export function heroFontFace(locale: Locale): string {
  return `@font-face{font-family:"Manrope Hero";font-weight:800;font-display:block;src:url(/fonts/hero-${locale}.woff2) format("woff2")}`;
}
